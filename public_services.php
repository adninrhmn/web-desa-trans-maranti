...
<div class="container">
  <section>
    <h2 class="saya">Layanan Publik</h2>
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($resultPembangunan)) {
            ...
            <tr>
              ...
              <td>
                <a href="detail_pembangunan_public.php?id_program_pembangunan=<?php echo $row['id_program_pembangunan']; ?>" class="btn btn-primary btn-sm">Detail</a>
              </td>
            </tr>
            <?php
          }
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($resultWisata)) {
              ...
              <tr>
                ...
                <td>
                  <a href="detail_wisata_public.php?id_wisata=<?php echo $row['id_wisata']; ?>" class="btn btn-primary btn-sm">Detail</a>
                </td>
              </tr>
              <?php
            }
