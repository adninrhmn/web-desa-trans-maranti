...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Query untuk menyimpan pengaduan dan saran ke database
  $query = "INSERT INTO pengaduan_saran (nama_pengirim, email, pesan) VALUES ('$nama_pengirim', '$email', '$pesan')";
  $result = mysqli_query($koneksi, $query);

  // Periksa apakah pengaduan dan saran berhasil disimpan
  if ($result) {
    // Redirect ke halaman informasi pengaduan dan saran
    header('Location: pengaduan_saran.php');
    exit();
  } else {
    // Pesan error jika pengaduan dan saran gagal disimpan
    $error = 'Terjadi kesalahan saat menyimpan pengaduan dan saran.';
  }
}
?>
...
.saya {
  ...
  text-align: center;
    ...
    .container-nya textarea {
      resize: vertical;
      height: 100px;
    }

    .container-nya button {
      display: block;
      width: 100%;
      padding: 10px;
...
<body>
  ...
  <div class="container-nya">
    <section>
      <h2 class="saya">Tambah Pengaduan dan Saran</h2>
      ...
      <!-- Form tambah pengaduan dan saran -->
