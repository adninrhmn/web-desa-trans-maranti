...
<html>
<head>
  <title>Hubungi Kami - Admin Panel</title>
...
<body>
  ...
  <div class="container">
    <section>
      ...
      <!-- Hubungi Kami content here -->
      <p>Anda dapat mengelola pesan-pesan yang masuk melalui formulir hubungi kami.</p>
      <table class="table">
        <thead>
          <tr>
            <th>Nama</th>
        ...
        <tbody>
          <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
              ...
              <td>
                <a href="detail_pesan.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Detail</a>
                <a href="edit_pesan.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Ubah</a>
                <a href="hapus_pesan.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
