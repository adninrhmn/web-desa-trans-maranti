...
if (isset($_POST['submit'])) {
  ...
  // Query untuk mengupdate data penduduk
  $query = "UPDATE penduduk_desa SET 
              nama = '$nama',
              NIK = '$NIK',
              ...
              agama = '$agama',
              etnis_suku = '$etnis_suku',
              status_kependudukan = '$status_kependudukan'
            WHERE id = '$id'";

  // Eksekusi query
  if (mysqli_query($koneksi, $query)) {
    // Redirect ke halaman data penduduk setelah berhasil diupdate
    header('Location: population.php');
    exit();
  } else {
...
<html>
<head>
  <title>Edit Data Penduduk - Admin Panel</title>
...
<body>
  ...
  <div class="container">
    <h2 class="section-title">Edit Data Penduduk</h2>
    <form method="post">
      <div class="mb-3">
        <label for="nama" class="form-label">Nama</label>
        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $penduduk['nama']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="NIK" class="form-label">NIK</label>
        <input type="text" class="form-control" id="NIK" name="NIK" value="<?php echo $penduduk['NIK']; ?>" required>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo $penduduk['tanggal_lahir']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
        <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?php echo $penduduk['tempat_lahir']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="alamat" class="form-label">Alamat</label>
        <textarea class="form-control" id="alamat" name="alamat" rows="3" required><?php echo $penduduk['alamat']; ?></textarea>
      </div>
      <div class="mb-3">
        <label for="status_perkawinan" class="form-label">Status Perkawinan</label>
        <select class="form-select" id="status_perkawinan" name="status_perkawinan" required>
          <option value="Belum Menikah" <?php if ($penduduk['status_perkawinan'] === 'Belum Menikah') echo 'selected'; ?>>Belum Menikah</option>
          <option value="Menikah" <?php if ($penduduk['status_perkawinan'] === 'Menikah') echo 'selected'; ?>>Menikah</option>
          <option value="Cerai" <?php if ($penduduk['status_perkawinan'] === 'Cerai') echo 'selected'; ?>>Cerai</option>
        </select>
      </div>
      <div class="mb-3">
        <label for="pekerjaan" class="form-label">Pekerjaan</label>
        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="<?php echo $penduduk['pekerjaan']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="pendidikan" class="form-label">Pendidikan</label>
        <input type="text" class="form-control" id="pendidikan" name="pendidikan" value="<?php echo $penduduk['pendidikan']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="kewarganegaraan" class="form-label">Kewarganegaraan</label>
        <input type="text" class="form-control" id="kewarganegaraan" name="kewarganegaraan" value="<?php echo $penduduk['kewarganegaraan']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="agama" class="form-label">Agama</label>
        <input type="text" class="form-control" id="agama" name="agama" value="<?php echo $penduduk['agama']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="etnis_suku" class="form-label">Etnis/Suku</label>
        <input type="text" class="form-control" id="etnis_suku" name="etnis_suku" value="<?php echo $penduduk['etnis_suku']; ?>" required>
      </div>
      <div class="mb-3">
        <label for="status_kependudukan" class="form-label">Status Kependudukan</label>
        <input type="text" class="form-control" id="status_kependudukan" name="status_kependudukan" value="<?php echo $penduduk['status_kependudukan']; ?>" required>
      </div>
