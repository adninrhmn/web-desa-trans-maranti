...
<html>
<head>
  <title>Detail Program Pembangunan - Admin Panel</title>
...
<body>
  ...
  <div class="container">
    <section>
      <h2 class="section-title">Detail Program Pembangunan</h2>
      <div class="mb-3">
        <label for="program_pembangunan" class="form-label">Program Pembangunan</label>
        <input type="text" class="form-control" id="program_pembangunan" name="program_pembangunan" value="<?php echo $data['program_pembangunan']; ?>" readonly>
      </div>
      <div class="mb-3">
        <label for="anggaran" class="form-label">Anggaran</label>
        <input type="text" class="form-control" id="anggaran" name="anggaran" value="<?php echo $data['anggaran']; ?>" readonly>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <br>
        <img src="../upload/<?php echo $data['gambar_kegiatan']; ?>" alt="Gambar Kegiatan" style="max-width: 300px;">
      </div>
