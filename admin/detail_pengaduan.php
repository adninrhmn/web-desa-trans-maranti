...
<html>
<head>
  <title>Detail Pengaduan dan Saran - Admin Panel</title>
...
<body>
  ...
  <div class="container">
    <section>
      <h2 class="section-title">Detail Pengaduan dan Saran</h2>

      <div class="card mb-3">
        <div class="card-header">
          <h5 class="card-title">Informasi Pengaduan dan Saran</h5>
        </div>
<div class="card-body">
  <p><strong>Nama Pengirim:</strong> <?php echo $row['nama_pengirim']; ?></p>
  <p><strong>Email:</strong> <?php echo $row['email']; ?></p>
  <p><strong>Pesan:</strong> <?php echo $row['pesan']; ?></p>
  <p><strong>Tanggal Pengaduan:</strong> <?php echo date('Y-m-d', strtotime($row['tanggal_pengaduan'])); ?></p>
</div>
