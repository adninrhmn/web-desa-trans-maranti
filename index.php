...
$query = "SELECT * FROM pesan"; // Ubah "penduduk" sesuai dengan nama tabel yang tepat
...
<div class="top-wrapper">
  <div class="container">
    ...
    <h2>SISTEM INFORMASI DESA TRANS MARANTI</h2>
    <h2>Temukan keindahan desa kami dan nikmati kehidupan pedesaan yang damai.</h2>
    <p>Sistem Informasi Desa Trans Maranti adalah sebuah platform yang memungkinkan warga desa Trans Maranti untuk mengakses informasi terkait desa dan wilayah sekitar. Melalui sistem ini, warga dapat mengakses informasi tentang potensi desa, layanan publik, keamanan, dan lain sebagainya.</p>
    <a href="lanjut.php" class="btn btn-success">Pelajari Lebih Lanjut</a>
  </div>
</div>
</div>
